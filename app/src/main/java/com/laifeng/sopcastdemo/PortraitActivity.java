...
import com.laifeng.sopcastsdk.utils.*;
...
public class PortraitActivity extends Activity {
    ...
    private void initLiveView() {
        ...
        int w = com.laifeng.sopcastsdk.utils.Utils.getDisplayWidth(this) / 2;
        int h = com.laifeng.sopcastsdk.utils.Utils.getDisplayHeight(this) / 4;
        Watermark watermark = new Watermark(watermarkImg, 100, 50, WatermarkPosition.WATERMARK_ORIENTATION_TOP_RIGHT, 20, 10);
//        mLFLiveView.setWatermark(watermark);

        //初始化flv打包器
        FlvPacker packer = new FlvPacker();
        packer.initAudioParams(AudioConfiguration.DEFAULT_FREQUENCY, 16, false);
        packer.initVideoParams(1920, 1080, 30);
